...
そこで登場するのが、[CSS Paged Media Module Level 3](https://www.w3.org/TR/css-page-3/) というCSSの規格です。これは、文章が紙に印刷されたりPDFになって、ページによって分割されたときにどのようにコンテンツが表示されるべきかを、CSSによって詳細に記述することができるようにするための規格です。
