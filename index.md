...
とはいえ、HTML/CSS が LaTeX の代わりとして使えるかもしれないということはこの記事で伝えられたと思います。私はそれだけで満足です。~~あの忌々しいLaTeXを駆逐するため、共に闘いましょう。~~
...
- CSS Paged Media Module Level 3 を使えるようにするツールは、Paged.js の他にもいくつかあります。[それらのツールを一覧にしてまとめているサイト]((https://print-css.rocks/lessons))があって、そのサイトでは以下の7つが紹介されていました。
